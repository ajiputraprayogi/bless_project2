    ...
    <footer className="w-full bg-[#F7F4EF] text-[#2E2B25] border-t border-[#2E2B25]/10">
      <div className="max-w-6xl mx-auto px-6 md:px-10 py-12 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        >
          ...
          <div>
            <h2 className="text-lg font-semibold tracking-tight">Bless Design</h2>
        ...
        >
          <a
            href="https://instagram.com/Bless.design"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://facebook.com/Blessdesain"
            target="_blank"
            rel="noreferrer"
            className="hover:text-[#C9A77A] transition-colors"
          >
          ...
          <a
            href="https://www.tiktok.com/@Bless.design"
            target="_blank"
            rel="noreferrer"
            className="hover:text-[#C9A77A] transition-colors"
          >
      ...
      <div className=" py-6 text-center text-xs opacity-70 mb-[2rem]">
        © {new Date().getFullYear()} Bless Design — All Right Reserved.
      </div>
    </footer>
  );
}
...
<button
  onClick={() =>
    window.open(
      "https://wa.me/6285176965609?text=Halo%2C%20saya%20ingin%20menanyakan%20layanan",
      "_blank"
    )
  }
  className="mt-2 px-4 py-3 bg-orange-600 text-white font-medium rounded-md 
             transition duration-300 ease-in-out transform hover:scale-105 hover:bg-orange-700 hover:text-white"
>
  Hubungi Kami
</button>

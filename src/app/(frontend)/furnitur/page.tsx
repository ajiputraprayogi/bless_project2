    ...
    return (
        <>
            ...
            <section className="max-w-6xl mx-auto px-4 py-20 mt-3">
                ...
                >
                    <p className="mb-4">
                        Sudah punya ide desain ruangan & mau merealisasikannya? Pakai jasa Desain Interior dan Furniture solusinya. Bless Architect melayani desain interior & furniture sehingga ide Anda dapat direalisasikan.
                    </p>
                    <p className="mb-4">
                        Kami melayani seluruh bentuk dan style hunian, pribadi maupun komersil dengan berbagai style seperti urban, eco, modern, tradisional, mediterania maupun bali, dan lainnya. Dengan pelayanan yang terstruktur dan terstandarisasi, kami melayani seluruh Indonesia.
                    </p>
                    <p>
                        Jika sudah ada ide silahkan komunikasikan dengan kami tetapi jika belum Anda tidak perlu khawatir kami akan menentukan desain yang cocok bagi ruang interior Anda. Wujudkan Impian Interior Furniture Anda Bersama Bless Architect.
                    </p>
                </motion.div>

...
export default function JasaKontraktorPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch("/api/portofolio/eksteriors?type=furnitur");
      ...
      <section className="relative w-full h-[60vh] md:h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center p-4">
          <motion.h1
            ...
            className="text-5xl md:text-7xl text-white font-bold tracking-tight text-center mb-4 drop-shadow-xl"
          >
            Interior
          </motion.h1>
        </div>
